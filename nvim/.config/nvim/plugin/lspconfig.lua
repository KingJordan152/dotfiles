...
local is_installed = {
  go = function() return utils.executable_exists("go") end,
  ruby = function()
  ...
  java = function() return utils.executable_exists("java") end,
  python = function() return utils.executable_exists("python") and utils.executable_exists("pip") end,
}
